package com.tasanahetech.mikroboxv2.api;

import java.util.List;
import java.util.Map;
import javax.net.SocketFactory;
import com.tasanahetech.mikroboxv2.api.impl.ApiConnectionImpl;
...
public abstract class ApiConnection implements AutoCloseable {
     ...
     * @throws com.tasanahetech.mikroboxv2.api.MikrotikApiException Thrown if there is a
     * problem connecting
     * @since 3.0
     */
     ...
     * @throws com.tasanahetech.mikroboxv2.api.MikrotikApiException Thrown if the API encounters an error on login.
     */
     ...
     * @throws com.tasanahetech.mikroboxv2.api.MikrotikApiException Thrown if the API encounters an error executing a command.
     */
     ...
     *
     * @throws com.tasanahetech.mikroboxv2.api.ApiConnectionException Thrown if there is a
